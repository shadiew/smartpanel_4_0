                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <select name="payment_params[option][currency_code]" class="form-control square ajaxChangeCurrencyCode">
                      ...
                      <option value="KWD" <?=(isset($option->currency_code) && $option->currency_code == 'KWD')? "selected" : ''?>>KWD - Kuwaiti Dinar</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control text-right currency-rate-value" name="payment_params[option][rate_to_usd]" value="<?php echo (isset($option->rate_to_usd)) ? $option->rate_to_usd : 0.301; ?>">
