            ...
            <div class="form-body">
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <label class="form-label">Token Public<span class="form-required">*</span></label>
                  ...
                  <div class="form-group">
                    <label class="form-label">Token Private<span class="form-required">*</span></label>
                  ...
                  <div class="form-group">
                    ...
                    <select name="payment_params[option][currency_code]" class="form-control square ajaxChangeCurrencyCode">
                      ...
                      <option value="CLP" <?=(isset($option->currency_code) && $option->currency_code == 'CLP')? "selected" : ''?>>CLP - Chilean peso</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control text-right currency-rate-value" name="payment_params[option][rate_to_usd]" value="<?php echo (isset($option->rate_to_usd)) ? $option->rate_to_usd : 789; ?>">
