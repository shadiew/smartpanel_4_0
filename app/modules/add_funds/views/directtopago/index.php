    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="for-group text-center">
          ...
          <img src="<?=BASE?>/assets/images/directoPagoLogo.png" alt="Paypay icon" style="height:90px;">

          <p class="p-t-10"><small><?=sprintf(lang("you_can_deposit_funds_with_directotpago_they_will_be_automaticly_added_into_your_account"), 'Directotpago')?></small></p>
