    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="for-group text-center">
          ...
          <img src="<?=BASE?>/assets/images/uphold-logo.jpg" alt="Paypay icon" style="height:90px;">
        ...
        <div class="form-group">
          ...
          <label>Instrucciones uphold Pago minimo $5 y pago maximo $100</label>
          <ul>
            <li>1. Inicia en tu cuenta Uphold</li>   
            <li> 2. Envia el pago a nuestro Uphold Correo: ellandax@protonmail.com, Envía en la nota o referencia de pago tu email registrado en 1popularity.</li>
          ...
          <label>Instructions uphold Minimum payment $5 and maximum payment $100</label>
          <ul>
            <li>1. Login to your Uphold account</li>   
            <li>2. Send the payment to our Uphold Mail: ellandax@protonmail.com, Send in the note or payment reference your email registered in 1popularity.</li>
